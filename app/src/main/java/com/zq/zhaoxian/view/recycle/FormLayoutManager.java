package com.zq.zhaoxian.view.recycle;
...
public class FormLayoutManager extends RecyclerView.LayoutManager {
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if ((mStartShowType & StartShowType.RIGHT) > 0 && mDefaultStartDx == 0){
                mDefaultStartDx = mTotalWidth - getHorizontalSpace();
                mSumDx = mDefaultStartDx;
            }

            if ((mStartShowType & StartShowType.BOTTOM) > 0 && mDefaultStartDy == 0){
